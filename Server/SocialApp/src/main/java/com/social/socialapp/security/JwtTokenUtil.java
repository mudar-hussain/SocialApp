...
public class JwtTokenUtil implements Serializable {
	...
	private String doGenerateToken(Map<String,Object> claims, String subject) {
		...
		return Jwts.builder()
				...
				.signWith(SecurityConstant.JWT_TOKEN_SIGNATURE_ALGORITHM, SecurityConstant.JWT_KEY)
				.setIssuer("SocialApp")
				.setSubject(subject)
				.compact();
	}
	...
	private Claims getAllClaimsFromToken(String token) {
		return Jwts.parser().setSigningKey(SecurityConstant.JWT_KEY).parseClaimsJws(token).getBody();
	}

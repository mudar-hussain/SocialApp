...
public class StoryController {
	...
	public ResponseEntity<List<StoryDto>> findAllStoryByUserIdHandler(@PathVariable("userIds") List<Integer> userIds) throws UserException, StoryException{
			
		List<StoryDto> stories = storyService.findAllStoryByUserIds(userIds);
